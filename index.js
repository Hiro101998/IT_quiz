...
answers:['あらかじめ読者として登録しておくと，登録したジャンルや、し好に合った内容のメールだけが自動的に配信される。',
'インターネットの検索エンジンで検索すると，検索結果に加えて，関連した内容の記事や広告も表示される。',
'自分のブログに他人のブログのリンクを張ったとき，相手に対してその旨が自動的に通知される。',
'利用者が過去にアクセスしたWebサイトに再度アクセスしたときに，その利用者に合わせた設定でWebページが表示される。'],
correct:'利用者が過去にアクセスしたWebサイトに再度アクセスしたときに，その利用者に合わせた設定でWebページが表示される。'
},
{
